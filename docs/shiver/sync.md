...
:::tip
Sync only moves data between paired Nanos on the same mesh. If a target device isn't showing up in the pickers, check the <a href="/docs/shiver/dashboard">Dashboard</a> to confirm it's online, and make sure it's on the same Long Range setting.
:::
